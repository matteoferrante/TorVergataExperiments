...
class cGAN(keras.Model):
    ...
    """
    class for conditional GAN extending keras.Model
    ...
    are generated in two step as in usual GAN cases:
    ...
    In the second step we will train the generator using the GAN approach generating fake images with random conditions
    ...
    #TODO: check and fix the training cycle?
    ...
    def train_step(self, data):
        ...
        The labels for the discriminator are generated as in the uncodinationed GAN cases.
